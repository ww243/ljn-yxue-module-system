    ...
    <script>
        $(function () {
            ...
            $('#captchaImage').click(function () {
                $('#captchaImage').prop('src','${path}/admin/core?d='+new Date().getTime());
            });
        });
    </script>
</head>
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="" method="post" class="login-form" id="loginForm">
                            ...
                            <div class="form-group">
                                ...
                                <img id="captchaImage" style="height: 48px" class="captchaImage" src="${path}/admin/core">
                                <input style="width: 289px;height: 50px;border:3px solid #ddd;border-radius: 4px;" required type="test" name="core" id="form-code">
                            </div>
                            <input type="submit" style="width: 400px;border:1px solid #9d9d9d;border-radius: 4px;"value="登录" id="formlogin">
                        </form>
                    </div>
                </div>
            </div>
